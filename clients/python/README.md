# tinistream-client
A client library for accessing tinistream
...
```python
from tinistream_client.models import MyDataModel
from tinistream_client.api.my_tag import get_my_data_model
from tinistream_client.types import Response
...
1. Any endpoint which did not have a tag will be in `tinistream_client.api.default`
...
```python
from tinistream_client import Client
